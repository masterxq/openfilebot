...
curl -O "https://mediaarea.net/download/binary/libmediainfo0/${MEDIAINFO_VERSION}/libmediainfo0v5_${MEDIAINFO_VERSION}-1_armhf.Raspbian_12.deb"
curl -O "https://mediaarea.net/download/binary/libzen0/${ZEN_VERSION}/libzen0v5_${ZEN_VERSION}-1_amd64.Debian_12.deb"
curl -O "https://mediaarea.net/download/binary/libzen0/${ZEN_VERSION}/libzen0v5_${ZEN_VERSION}-1_armhf.Raspbian_12.deb"
...
cp Staging/*/data/usr/lib/arm-linux-gnueabihf/libmediainfo.so.0.0.0 linux-armv7l/libmediainfo.so
cp Staging/*/data/usr/lib/x86_64-linux-gnu/libzen.so.${ZEN_VERSION} linux-amd64/libzen.so
cp Staging/*/data/usr/lib/arm-linux-gnueabihf/libzen.so.${ZEN_VERSION} linux-armv7l/libzen.so
