...
public final class Logging {
	...
	private static final SystemProperty<Level> debugLevel = SystemProperty.of("org.openfilebot.logging.debug", "net.filebot.logging.debug", Level::parse, Level.WARNING);
	private static final SystemProperty<Pattern> anonymizePattern = SystemProperty.of("org.openfilebot.logging.anonymize", "net.filebot.logging.anonymize", Pattern::compile);
	private static final SystemProperty<Boolean> color = SystemProperty.of("org.openfilebot.logging.color", "net.filebot.logging.color", Boolean::parseBoolean, Color.isSupported());

	public static final Logger log = createConsoleLogger("org.openfilebot.console", Level.ALL);
	public static final Logger debug = createConsoleLogger("org.openfilebot.debug", debugLevel.get());
