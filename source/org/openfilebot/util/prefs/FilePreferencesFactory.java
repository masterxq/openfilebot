package org.openfilebot.util.prefs;
...
public class FilePreferencesFactory implements PreferencesFactory {
	...
	public static Path getBackingStoreFile() {
		return Paths.get(SystemProperty.of("org.openfilebot.util.prefs.file", "net.filebot.util.prefs.file", value -> value, "prefs.properties").get());
	}
