...
public class ShooterSubtitles implements VideoHashSubtitleService {
	...
	protected URL getSubApiUrl() {
		try {
			return new URL(SystemProperty.of("org.openfilebot.web.ShooterSubtitles.url", "net.filebot.web.ShooterSubtitles.url", value -> value, "https://www.shooter.cn/api/subapi.php").get());
