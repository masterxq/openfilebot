...
import org.openfilebot.UserFiles.FileChooser;
import org.openfilebot.cli.ArgumentBean;
import org.openfilebot.util.PreferencesList;
import org.openfilebot.util.PreferencesMap;
import org.openfilebot.util.PreferencesMap.JsonAdapter;
import org.openfilebot.util.PreferencesMap.PreferencesEntry;
import org.openfilebot.util.PreferencesMap.StringAdapter;
...
public final class Settings {
	...
	public static String getApplicationUserModelID() {
		return SystemProperty.of("org.openfilebot.AppUserModelID", "net.filebot.AppUserModelID", value -> value, getApplicationName()).get();
	}

	public static FileChooser getPreferredFileChooser() {
		return SystemProperty.of("org.openfilebot.UserFiles.fileChooser", "net.filebot.UserFiles.fileChooser", FileChooser::valueOf, FileChooser.Swing).get();
	}
